        ...
        if (current_user_can('edit_posts') && ($pagenow == 'post-new.php' || $pagenow == 'post.php' )) {
			    if( isset($post) ) {
					wp_localize_script( 'jquery', 'script_data', array(
						...
						'label_create' => __("Create Featured Gallery", "listingpro"),
						'label_edit' => __("Edit Featured Gallery", "listingpro"),
						'label_save' => __("Save Featured Gallery", "listingpro"),
						'label_saving' => __("Saving...", "listingpro")
					));
				}
			...
			wp_enqueue_script('maps', 'https://maps.googleapis.com/maps/api/js?v=3&amp;key=AIzaSyDQIbsz2wFeL42Dp9KaL4o4cJKJu4r8Tvg&amp;libraries=places', 'jquery', '', false);
...
function savePostMeta($post_id) {
    global $listingpro_settings, $reviews_options, $listingpro_formFields, $claim_options, $ads_options;
