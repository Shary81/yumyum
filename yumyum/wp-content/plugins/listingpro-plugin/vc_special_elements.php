	...
	<div class="thankyou-page">
		...
		<div class="thankyou-panel">
			...
			<ul>
				...
				<li>
					<a href="'.esc_url(home_url('/')).'">'.esc_html__('Home', 'listingpro').'</a>
				</li>
			</ul>
		</div>
	</div>';
					...
					$output .= '<div class="'.$gridStyle.'">
									<div class="city-girds lp-border-radius-8">
										<div class="city-thumb">
											<img src="'. $imgurl.'" alt="london" />
										</div>
										<div class="city-title text-center">
											<h3 class="lp-h3">
												<a href="'.esc_url( get_term_link( $location->term_id , 'location')).'">'.esc_attr($location->name).'</a>
											</h3>
											<label class="lp-listing-quantity">'.esc_attr($location->count).' '.esc_html__(listingpro_translation('Listings'), 'listingpro').'</label>
										</div>
									...
									<div class="lp-blog-grid-box-container lp-border lp-border-radius-8">
										...
										<div class="lp-blog-grid-box-description text-center">
												<div class="lp-blog-user-thumb margin-top-subtract-25">
													'.get_avatar( get_the_author_meta( 'ID' ), 51 ).'
												</div>
