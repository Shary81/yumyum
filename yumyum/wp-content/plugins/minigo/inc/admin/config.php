...
class PremioThemes_ComingSoon_Admin {
    ...
    function __construct() {
        ...
        $args = array(
            ...
            'display_name'           => '<img width="96" height="96" src="'.plugins_url( 'img/logo.png' , __FILE__ ).'"><a href="//www.premiothemes.com/" target="_blank" style="display: none;" class="premiothemes-logo"><img width="150" height="30" src="'.plugins_url( 'img/premiothemes-logo.png' , __FILE__ ).'"></a>', // This variable sets the title that appears at the top of the options panel.
        ...
        $profiles_url = '//premiothemes.com/demos/minigo/assets/template/images/content/profiles/';
        ...
        $sections[] = array(
            ...
            'fields' => array(
                ...
                array(
                    ...
                    'subtitle'=> __('Write URLs one per line, including the // part of the url.', 'pt-minigo').'<br>'.__('You can use an asterisk * as a wildcard.', 'pt-minigo').
                                    '<p>'.__('For example: ', 'pt-minigo').'<code>//example.com/blog/</code> '.__('only matches that exact URL while' , 'pt-minigo').'<code>//example.com/blog/*</code> '.__('would match any URL starting with ', 'pt-minigo').'//example.com/blog/ <p>
                                    <p>'.__('Also,', 'pt-minigo').' <code>//*example.com/blog/</code> '.__('would match', 'pt-minigo').' //example.com/blog/ '.__('as well as', 'pt-minigo').' //www.example.com/blog/ '.__('or any other subdomain.', 'pt-minigo').'</p>',
                    "default"       => home_url().'*',
                    'required' => array('display-on', '=','custom'),
                    ),
                array(
        ...
        $sections[] = array(
            ...
            'fields' => array(
                ...
                array(
                    ...
                    'default' => array('url' => '//premiothemes.com/demos/minigo/assets/template/images/logo.png')
                    ),
                array(
                    'id'=>'logo-width',
                    'type' => 'text',
                ...
                array(
                    ...
                    'subtitle' => __('This typically shows up as the title for your search engine listing.', 'pt-minigo') . '<br>' . __('Ideally try to keep it under 50 characters, after 70 google truncates it.', 'pt-minigo') .'<br>' . __('This tool helps: ', 'pt-minigo') . '<a href="//www.serpsimulator.com/" target="_blank">' . __('Serp Simulator', 'pt-minigo') . '</a>.',
                ),
                array(
                    'id'=>'meta-description',
                    'type'=>'textarea',
        ...
        $sections[] = array(
            ...
            'fields' => array(
                ...
                array(
                    ...
                    'default' => array('url' => '//premiothemes.com/demos/minigo/assets/template/images/logo-dark.png')
                    ),
                array(
        ...
        $sections[] = array(
            ...
            'fields' => array(
                    ...
                    //     'textarea_rows' => 20
                    // ),
                    // 'default' => 'Copyright ©2016 <a href="//premiothemes.com" target="_blank">PremioThemes</a>. All rights reserved.',
                    // ),
            )
        );
        ...
        $sections[] = array(
            ...
            'fields' => array(
                ...
                array(
                    ...
                    'default' => array('url' => '//premiothemes.com/demos/assets/video/bg-video-01.mp4')
                    ),
                array(
                    ...
                    'default' => array('url' => '//premiothemes.com/demos/assets/video/bg-video-01.webm')
                    ),
                array(
                    ...
                    'default' => array('url' => '//premiothemes.com/demos/assets/video/bg-video-01.ogv')
                    ),
                ...
                array(
                    ...
                    'validate' => 'url',
                    'default' => '//www.youtube.com/watch?v=ab0TSkLe-E0',
                    'class' => 'regular-text'
                    ),
                array(
                ...
                array(
                    ...
                    'default' => '14715111',
                    'hint' => array(
                        'content' => '//vimeo.com/<strong>14715111</strong>',
                        )
                    ),
                array(
        ...
        $sections[] = array(
            ...
            'fields' => array(
                ...
                'subtitle' => __('If set to Yes, it enables Double Opt-in. See the', 'pt-minigo').' <a target="_blank" href="//kb.mailchimp.com/article/how-does-confirmed-optin-or-double-optin-work/">'.__('this link', 'pt-minigo').'</a> '.__('for reference on how it works.', 'pt-minigo'),
                'on' => 'Yes',
                'off' => 'No',
                'default' => 0,
                ),
        ...
        $sections[] = array(
            ...
            'fields' => array(
                ...
                array(
                    ...
                    'default' => '//premiothemes.com/demos/assets/audio/wathne-lounge.mp3'
                ),
                array(
                    'id' => 'track-name',
                    'type' => 'text',
        ...
        'fields' => array(
                ...
                array(
                    ...
                    // 'desc' => __('The icons are from ', 'pt-minigo').'<a href="//fontawesome.io/" target="_blank">Font Awesome</a>',
                    'required' => array('page-1-enabled','=','1'),
                    'required' => array('page-1-nav','=','1'),
                    'options' => minigo_get_font_awesome_icons(),
                    'class' => 'font-awesome-icons',
        ...
        $sections[] = array(
            ...
            'subtitle' => __('Set up your contact info shortcode below.', 'pt-minigo') . '<a href="//universimmedia.pagesperso-orange.fr/geo/loc.htm" target="_blank">' . __('here', 'pt-minigo') .'</a>',
        ...
        $sections[] = array(
            ...
            'desc' => __('This can be accessed by using the ', 'pt-minigo').'<strong>[minigo-map]</strong> '.__('shortcode in your pages.', 'pt-minigo') . '<br>' . __('Find your coordinates', 'pt-minigo') . ' <a href="//universimmedia.pagesperso-orange.fr/geo/loc.htm" target="_blank">' . __('here', 'pt-minigo') .'</a>',
            'subsection' => true,
            ...
            $sections[] = array(
                ...
                'fields' => array(
                    array(
                        ...
                        'subtitle' => __('Don\'t know where to find it?','pt-minigo').'<br>'.__('Follow our ', 'pt-minigo').'<a target="_blank" href="//premiothemes.com/help/purchase-key/">'.__('quick tutorial', 'pt-minigo').'</a>!',
                    ),
                   array(
