...
$use_Mailchimp = $pt_minigo['subscribe-use_Mailchimp'];

// Fill in you API Key here if the above option is true
$mailchimp_API_Key = $pt_minigo['subscribe-Mailchimp_API_Key'];

// The ID of the mailchimp list where you want to save the contacts
$mailchimp_list_ID = $pt_minigo['subscribe-Mailchimp_list_ID'];
...
$mailchimp_double_optin = $pt_minigo['subscribe-Mailchimp_double_optin'];

// If Double Opt-in is disabled, you can still send a Welcome message by setting the following to true
$mailchimp_send_welcome = $pt_minigo['subscribe-Mailchimp_send_welcome'];
...
$target_address = $pt_minigo['contact-target-address'];
...
$from_address = $pt_minigo['contact-from-address'];

// Prefix for the email subject. Useful for filtering mail.
$subject_prefix = $pt_minigo['contact-subject-prefix'];
?>