/** Rainy Day JS Animation
 ** =============================
 ** Author  | Marek Brodziak | http://maroslaw.github.io/rainyday.js/
 *  License | GPL
 */
/**
...
// function RainyDay(options, '#js-animation-canvas') {
...
RainyDay.prototype.prepareCanvas = function() {
	...
	var canvas = document.getElementById('js-animation-canvas');
