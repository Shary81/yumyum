						...
						<div class="ui-block popup-chat">
							...
							<div class="mCustomScrollbar" data-mcs-theme="dark">
								<ul class="notification-list chat-message chat-message-field">
									<li>
										<div class="author-thumb">
											<img  src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/avatar14-sm.jpg" alt="author">
										</div>
										<div class="notification-event">
									...
									<li>
										...
										<span class="chat-message-item">Hi Elaine! I have a question, do you think that tomorrow we could talk to
											...
											<div class="added-photos">
												<img  src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/photo-message1.jpg" alt="photo">
												<img  src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/photo-message2.jpg" alt="photo">
