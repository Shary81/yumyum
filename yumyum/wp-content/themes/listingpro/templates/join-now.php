						...
						<div class="lp-join-now">
							...
							<a	href="<?php echo home_url('/login'); ?>"><?php esc_html_e('Sign Up', 'listingpro'); ?></a>
						...
						<div class="lp-join-now">
							...
							<!--<a class=" md-trigger" data-modal="modal-3"><?php //esc_html_e('Login', 'listingpro'); ?></a>-->
							<a href="<?php echo home_url('/login'); ?>"><?php esc_html_e('Login', 'listingpro'); ?></a>
						</div>
						<?php }else{
						...
						<div class="lp-join-now after-login lp-join-user-info">
							<ul>
								<li>
									<span>
										<img src="<?php /*echo listingpro_author_image();*/ echo get_stylesheet_directory_uri(); ?>/assets/images/author-page.jpg" alt="userimg" />
									</span>
									<?php
									...
									<ul class="lp-user-menu list-style-none">
										...
										<li><a href="<?php echo listingpro_url('listing-author'); ?>#updateprofile"><?php esc_html_e('Update Profile','listingpro'); ?></a></li>
