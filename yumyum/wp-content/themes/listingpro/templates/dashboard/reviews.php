									  ...
									  <div id="2" class="tab-pane fade in active">
										...
										<?php
											...
											if(isset($_POST['submit_response'])){
												...
												$headers[]= 'From: '.$from . "\r\n";
												wp_mail( $userEmail, 'Review Response', $body, $headers );
											...
											if ( $wp_query->have_posts() ) {
												while ( $wp_query->have_posts() ) {
													...
													$review_post = listing_get_metabox_by_ID('listing_id', get_the_ID());
														...
														echo '<td class="comment column-comment has-row-actions column-primary" data-colname="Comment">
															<h4> <span>'.get_the_author_meta('display_name').'</span> posted a review on <a href="'.get_the_permalink($review_post).'">'.get_the_title($review_post).'</a>
															</h4>
															...
															<div class="review-content">
																<p><span><strong>Review:</strong></span>'.get_the_content().'</p>
																<div class="reviews">';
																	if( !empty($review_reply) ){
																		echo '<span class="pull-left">'.esc_html__('Reply Closed','listingpro').'</span>';
																	}else{
																		echo '<a href="#" class="open-reply pull-left">'.esc_html__('Reply this review','listingpro').'</a>';
																	}
																	if( !empty($review_reply) ){
																		...
																		echo '<input type="submit" value="Send Reply" name="submit_response" class="lp-review-btn">';
												...
												wp_reset_postdata();
													...
													<div class="text-center no-result-found col-md-12 col-sm-6 col-xs-12 margin-bottom-30">
														...
														<p><?php esc_html_e('Sorry ! Your have no received Reviews yet!','listingpro'); ?></p>
													</div>
													<?php
											}
										?>
