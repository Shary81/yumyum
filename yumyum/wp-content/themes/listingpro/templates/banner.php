	...
	<?php 
		...
		<?php if( is_tax('listing-category') ){ ?>
			<?php
				...
				if($category_banner){
			?>
				<div class="" style="background:url(<?php echo esc_attr($category_banner); ?>);">
			<?php
				} else{
			?>
				<div class="page-heading listing-page">
						...
						<div class="row">
							...
							<div class="col-md-8 col-xs-12 col-md-offset-2 col-sm-offset-0">
								...
								<div class="text-center lp-search-description">
									...
									<?php } ?>
									<img src="<?php// echo get_template_directory_uri(); ?>/assets/images/banner-arrow.png" alt="" class="banner-arrow" />
								</div>
							</div>
						</div>
					</div>
