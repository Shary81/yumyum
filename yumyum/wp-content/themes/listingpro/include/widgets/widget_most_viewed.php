		...
		if($videosPosts->found_posts > 0) {
			while ($videosPosts->have_posts()) {
				...
				if(has_post_thumbnail()) {
					...
					$image = '<img src="'.esc_url('https://placeholdit.imgix.net/~text?txtsize=33&txt=ListingPro&w=184&h=135').'" alt="Listing Pro Placeholder">';
				}
				?>
				<article>
					<figure>
					...
					<div class="details">
						...
						<div class="listing-options">
							...
							<?php } ?>
							<span class="post-reviews"><?php echo listingpro_ratings_numbers($post->ID); ?> <?php echo esc_html__('Reviews', 'listingpro'); ?></span>
						</div>
