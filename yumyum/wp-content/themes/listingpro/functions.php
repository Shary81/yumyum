 ...
 */
	...
	function listingpro_style() {
		/*f*/
		//wp_enqueue_style('bootstrap', THEME_DIR . '/assets/lib/bootstrap111/css/bootstrap.css');
		wp_enqueue_style('bootstrap', THEME_DIR . '/assets/lib/Bootstrap/dist/css/bootstrap.css');
		wp_enqueue_style('bootstrap', THEME_DIR . '/assets/lib/Bootstrap/dist/css/bootstrap-reboot.css');
		wp_enqueue_style('bootstrap', THEME_DIR . '/assets/lib/Bootstrap/dist/css/bootstrap-grid.css');
		wp_enqueue_style('select-bootstrap', THEME_DIR . '/assets/css/bootstrap-select.css');
		wp_enqueue_style('datepicker-bootstrap', THEME_DIR . '/assets/css/daterangepicker.css');
		wp_enqueue_style('Customscroll', THEME_DIR . '/assets/css/jquery.mCustomScrollbar.min.css');
		/*end f*/
		...
		wp_enqueue_style('block', THEME_DIR . '/assets/css/blocks.css');
	...
	function listingpro_scripts() {
		...
		/*f*/
		wp_enqueue_script('Mainhtmljs', THEME_DIR. '/assets/js/main-htmljs.js', 'jquery', '', true);
		wp_enqueue_script('mat', THEME_DIR. '/assets/js/material.min.js', 'jquery', '', true);
		wp_enqueue_script('Themeplugin', THEME_DIR. '/assets/js/theme-plugins.js', 'jquery', '', true);
		wp_enqueue_script('moment', THEME_DIR. '/assets/js/moment.min.js', 'jquery', '', true);
		wp_enqueue_script('daterangepick', THEME_DIR. '/assets/js/daterangepicker.min.js', 'jquery', '', true);
