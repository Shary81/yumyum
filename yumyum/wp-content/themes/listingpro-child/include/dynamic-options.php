...
?>
    ...
    <style>
		...
		if(!empty($top_bar_bgcolor)) { ?>
			.lp-topbar {
				background-color: <?php echo $top_bar_bgcolor; ?>
			}
		<?php } ?>


		<?php if(!empty($lp_page_header)){ ?>
		.listing-page{
		...
		.dashboard-content .lp-main-tabs .nav-tabs > li a:hover, .dashboard-tabs.lp-main-tabs.text-center  ul  li  a.active-dash-menu {
			border-left-color: <?php echo $themeClr; ?>;
		}

		.lpmap-icon-shape.cardHighlight::after, [data-tooltip].simptip-position-top::before {
			border-top-color: <?php echo $themeClr; ?> !important;
		}

		.dashboard-tabs.lp-main-tabs.text-center > ul > li.opened:hover > a,
		.dashboard-tabs.lp-main-tabs.text-center > ul > li:hover > a,
		.dashboard-tabs.lp-main-tabs.text-center ul li a.active-dash-menu {
			border-left-color: <?php echo $themeClr; ?> !important;
		}

		[data-tooltip].simptip-position-right::before, [data-tooltip].simptip-position-top.half-arrow::before,
		[data-tooltip].simptip-position-bottom.half-arrow::before {
			border-right-color: <?php echo $themeClr; ?> !important;
		}
		...
		[data-tooltip].simptip-position-bottom::before {
			border-bottom-color: <?php echo $themeClr; ?> !important;
		}
		...
		.dashboard-content .lp-pay-options .promotebtn:hover {
		    background-color: <?php echo $secThemeClr; ?>;
		}

		.lp-tabs .lp-pay-publsh:hover {
		    background-color: <?php echo $secThemeClr; ?> !important;
		}
		...
		.resurva-booking ul li.clearfix > form#booking > span, .dashboard-content .lp-pay-options .promotebtn {
			color: <?php echo $secThemeClr; ?>;
		}

		.nav-tabs > li > a::after{
			border-bottom-color: <?php echo $secThemeClr; ?>;
		}
		...
		.listing-second-view a.secondary-btn.make-reservation:hover, .dashboard-content .lp-pay-options .promotebtn {
			border-color: <?php echo $secThemeClr; ?>;
		}
