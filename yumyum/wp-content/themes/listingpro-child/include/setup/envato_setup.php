	...
	public function setup_wizard_header() {
		...
		public function envato_setup_default_content() {
			...
			<form method="post">
				...
				<?php } else { ?>
					<p><?php printf( esc_html__( 'It\'s time to insert some default content for your new WordPress website. Choose what you would like inserted below and click Continue. It is recommended to leave everything selected. Once inserted, this content can be managed from the WordPress admin dashboard. ', 'listingpro' ), '<a href="' . esc_url( admin_url( 'edit.php?post_type=page' ) ) . '" target="_blank">', '</a>' ); ?></p>
				<?php } ?>
	  ...
	  if ( !defined('WP_LOAD_IMPORTERS') ) define('WP_LOAD_IMPORTERS', true);
		...
		public function listingpro_homepage(){
			...
			$denverImg = get_template_directory_uri().'/assets/images/dashboard-img.jpg';

			update_term_meta( 15, 'lp_location_image', $denverImg );
			update_term_meta( 17, 'lp_location_image', $denverImg );
			update_term_meta( 18, 'lp_location_image', $denverImg );
			update_term_meta( 24, 'lp_location_image', $denverImg );
		...
		public function envato_setup_ready() {
			...
			<p>Please come back and <a href="http://themeforest.net/downloads" target="_blank">leave a 5-star rating</a>
				if you are happy with this theme. <br/>Follow <a href="https://twitter.com/cridiostudio" target="_blank">@cridiostudio</a>
				on Twitter to see updates. Thanks! </p>

			<div class="envato-setup-next-steps">
				<div class="envato-setup-next-steps-first">
					<h2><?php esc_html_e( 'Next Steps', 'listingpro' ); ?></h2>
					<ul>
						<li class="setup-product"><a class="button button-primary button-large"
						                             href="https://twitter.com/cridiostudio"
						                             target="_blank"><?php esc_html_e( 'Follow @cridiostudio on Twitter', 'listingpro' ); ?></a>
						</li>
						<li class="setup-product"><a class="button button-next button-large"
						                             href="<?php echo esc_url( home_url() ); ?>"><?php esc_html_e( 'View your new website!', 'listingpro' ); ?></a>
						</li>
					</ul>
				</div>
				<div class="envato-setup-next-steps-last">
					<h2><?php esc_html_e( 'More Resources', 'listingpro' ); ?></h2>
					<ul>
						<li class="documentation"><a href="http://cridio.com"
						                             target="_blank"><?php esc_html_e( 'Read the Theme Documentation', 'listingpro' ); ?></a>
						</li>
						<li class="howto"><a href="https://wordpress.org/support/"
						                     target="_blank"><?php esc_html_e( 'Learn how to use WordPress', 'listingpro' ); ?></a>
						</li>
						<li class="rating"><a href="http://themeforest.net/downloads"
						                      target="_blank"><?php esc_html_e( 'Leave an Item Rating', 'listingpro' ); ?></a></li>
						<li class="support"><a href="http://cridio.com"
						                       target="_blank"><?php esc_html_e( 'Get Help and Support', 'listingpro' ); ?></a></li>
					</ul>
				</div>
			</div>
			<?php
