				...
				<ul class="notification-list">
					...
					<li class="with-comment-photo">
						...
						<div class="comment-photo">
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/comment-photo.jpg" alt="photo">
					...
					<li>
						...
						<div class="notification-event">
							...
							<span class="notification-icon">
								<svg class="olymp-calendar-icon"><use xlink:href="<?php echo get_stylesheet_directory_uri(); ?>/assets/icons/icons.svg#olymp-calendar-icon"></use></svg>
							</span>
					...
					<li>
						<div class="author-thumb">
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/avatar6-sm.jpg" alt="author">
						</div>
						<div class="notification-event">
