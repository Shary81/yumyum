<?php
	/*
		Template Name: education_employment
	*/
	get_header();
						...
						<div class="row">
							...
							<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
								...
								<a href="#" class="add-field">
									<svg class="olymp-plus-icon"><use xlink:href="<?php echo get_stylesheet_directory_uri(); ?>/assets/icons/icons.svg#olymp-plus-icon"></use></svg>
