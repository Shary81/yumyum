...
function wp_insert_user( $userdata ) {
	...
	$country = empty( $userdata['country'] ) ? '' : $userdata['country'];
	$usertype = empty( $userdata['usertype'] ) ? '' : $userdata['usertype'];
	/**
	...
	$meta['gender'] = apply_filters('pre_user_gender', $gender);
	$meta['country'] = apply_filters('pre_user_country', $country);
	$meta['usertype'] = apply_filters('pre_user_usertype', $usertype);
	//$usertype = empty( $userdata['usertype'] ) ? '' : $userdata['usertype'];
 ...
 *                      be created.
 */
function wp_create_user($first_name ,$username, $password, $email = '',$gender, $country,$usertype) {
	$first_name = wp_slash($first_name);
	$user_login = wp_slash( $username );
	$user_email = wp_slash( $email    );
	$gender = wp_slash( $gender );
	$country = wp_slash( $country );
	$usertype = wp_slash( $usertype );
	$user_pass = $password;

	$userdata = compact('first_name', 'user_login', 'user_email', 'user_pass','gender','country','usertype');
